...
export const spells: Spell[] = [
  ...
  },
  {
    ...
    castingTime: '1 action',
    range: '60 feet',
    components: { verbal: true, somatic: true, material: 'a pinch of sand or rose petals' },
    duration: 'Concentration, up to 1 minute',
    concentration: true,
    ritual: false,
    ...
    areaOfEffect: { type: 'cube', size: 10 },
    endsOnDamage: true,
    repeatSave: {
      ability: 'wisdom',
      onEndOfTurn: true,
  ...
  },
  {
    ...
    ritual: false,
    description:
      "You touch one willing creature and choose Acid, Cold, Fire, Lightning, or Poison. Until the spell ends, the creature can take a Magic action to exhale a 15-foot Cone. Each creature in that area makes a Dexterity saving throw, taking 3d6 damage of the chosen type on a failed save or half as much on a successful one.",
    higherLevels:
  ...
  },
  {
    ...
    castingTime: '1 action',
    range: '60 feet',
    components: { verbal: true, material: 'bat fur and a piece of coal' },
    duration: 'Concentration, up to 10 minutes',
    concentration: true,
    ritual: false,
    description: 'Magical Darkness spreads from a point within range and fills a 15-foot-radius Sphere. Darkvision can\'t see through it, and nonmagical light can\'t illuminate it.',
    classes: ['sorcerer', 'warlock', 'wizard'],
    areaOfEffect: { type: 'sphere', size: 15, origin: 'point' },
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: 'You conjure a 5-foot-diameter sphere of fire in an unoccupied space within range. Any creature that ends its turn within 5 feet of the sphere makes a DEX save, taking 2d6 fire damage on a fail or half on a success. As a Bonus Action, you can move the sphere up to 30 feet. If it enters a creature\'s space, it stops and that creature makes the save.',
    higherLevels: 'The damage increases by 1d6 for each spell slot level above 2nd.',
    upcastDice: { dicePerLevel: '1d6' },
    ...
    createsZone: ZoneType.FlamingSphere,
    conditionOnSelf: 'flaming_sphere',
  },
  {
    id: 'alter-self',
    name: 'Alter Self',
    ...
    concentration: true,
    ritual: false,
    description: 'You alter your physical form. Choose Natural Weapons (1d6 + spellcasting mod unarmed strikes) or Aquatic Adaptation (swim speed, water breathing).',
    classes: ['sorcerer', 'wizard'],
  },
  {
    id: 'cloud-of-daggers',
    ...
    concentration: true,
    ritual: false,
    description: 'You conjure spinning daggers in a 5-foot Cube centered on a point within range. Each creature in that area takes 4d4 Slashing damage. A creature also takes this damage if it enters the Cube or ends its turn there. A creature takes this damage only once per turn.',
    higherLevels: 'The damage increases by 2d4 for each spell slot level above 2.',
    upcastDice: { dicePerLevel: '2d4' },
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    damage: {
      type: 'slashing',
      dice: '4d4',
    },
    areaOfEffect: { type: 'cube', size: 5, origin: 'point' },
    createsZone: ZoneType.CloudOfDaggers,
  },
  {
    id: 'arcane-vigor',
    name: 'Arcane Vigor',
    ...
    concentration: false,
    ritual: false,
    description: 'You tap into your life force to heal yourself. Roll one or two of your unexpended Hit Dice, and regain a number of Hit Points equal to the roll\'s total plus your spellcasting ability modifier. Those dice are then expended.',
    higherLevels: 'The number of unexpended Hit Dice you can roll increases by one for each spell slot level above 2nd.',
    classes: ['sorcerer', 'wizard'],
    targetType: 'self',
  },
  {
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: 'One Humanoid you can see within range must succeed on a Wisdom saving throw or have the Charmed condition for the duration. A spectral crown appears on the target\'s head, and it must use its action to make a melee attack against a creature you choose. The target repeats the save at the end of each of its turns, ending the spell on a success.',
    classes: ['bard', 'sorcerer', 'warlock', 'wizard'],
    savingThrow: 'wisdom',
    conditionOnFailedSave: 'charmed',
    repeatSave: {
  ...
  },
  {
    ...
    concentration: true,
    ritual: false,
    description: 'A Line of strong wind 60 feet long and 10 feet wide blasts from you in a direction you choose for the duration. Each creature in the Line must succeed on a Strength saving throw or be pushed 15 feet away from you in a direction following the Line. A creature that ends its turn in the Line must make the same save. Any creature in the Line must spend 2 feet of movement for every 1 foot it moves when moving closer to you. As a Bonus Action on each of your later turns, you can change the direction in which the Line blasts from you.',
    classes: ['druid', 'ranger', 'sorcerer', 'wizard'],
    savingThrow: 'strength',
    areaOfEffect: { type: 'line', size: 60, origin: 'self' },
    createsZone: ZoneType.GustOfWind,
  },
  {
    id: 'hold-person',
    name: 'Hold Person',
...

  {
    ...
    castingTime: '1 action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'a pinch of powdered iron' },
    duration: 'Concentration, up to 1 minute',
    concentration: true,
    ritual: false,
    description: 'For the duration, a creature or object you can see within range changes size. Enlarge: size increases by one category, advantage on Strength checks and saves, +1d4 weapon damage. Reduce: size decreases by one category, disadvantage on Strength checks and saves, -1d4 weapon damage (minimum 1).',
    savingThrow: 'constitution',
    classes: ['bard', 'druid', 'sorcerer', 'wizard'],
    targetType: 'any',
  },
  ...
  },
  {
    ...
    castingTime: '1 action',
    range: 'Touch',
    components: { verbal: true, somatic: true, material: 'a flask of Holy Water worth 25+ GP, which the spell consumes' },
    duration: 'Concentration, up to 10 minutes',
    concentration: true,
    ritual: false,
  ...
  },
  {
    ...
    castingTime: '1 action',
    range: '60 feet',
    components: { verbal: true, somatic: true, material: 'a twig struck by lightning' },
    duration: 'Concentration, up to 1 minute',
    concentration: true,
    ritual: false,
  ...
  },
  {
    ...
    castingTime: '1 action',
    range: '30 feet',
    components: { verbal: true, somatic: true, material: 'a tart and a feather' },
    duration: 'Concentration, up to 1 minute',
    concentration: true,
    ritual: false,
    description: "One creature of your choice that you can see within range makes a Wisdom saving throw. On a failed save, it has the Prone and Incapacitated conditions for the duration. It laughs uncontrollably if it's capable of laughter, and it can't end the Prone condition on itself.",
    higherLevels: 'You can target one additional creature for each spell slot level above 1.',
    classes: ['bard', 'warlock', 'wizard'],
    savingThrow: 'wisdom',
    conditionsOnFailedSave: ['prone', 'incapacitated'],
    repeatSave: {
      ability: 'wisdom',
      onEndOfTurn: true,
      onDamage: true,
      advantageOnDamage: true,
    },
    targetType: 'enemy',
    multiTarget: {
      baseCount: 1,
